...
#############
    #Only keeps mesurements between 1970 and 2010
###############

FILTER_FILTERFILENAME_ONLY1970to2010="1970_to_2010_$FILTER_FILTEREDFILENAME"
log "Only saving measurements taken between 1970 and 2010, writing to $FILTER_FILTERFILENAME_ONLY1970to2010"
grep -E '19[7-9][0-9]|200[0-9]|2010' $CLEANER_BAREDATAFILENAME > $FILTER_FILTERFILENAME_ONLY1970to2010
