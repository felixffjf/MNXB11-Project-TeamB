...
#############
    #Avrage the yearly temp for 10 years 
###############

FILTER_FILTERFILENAME_ONLY1990to2000="1990_to_2000_$FILTER_FILTEREDFILENAME"
log "Only saving measurements taken between 1990 and 2000, writing to $FILTER_FILTERFILENAME_ONLY1990to2000"
grep -E '199[0-9]|2000' $CLEANER_BAREDATAFILENAME > $FILTER_FILTERFILENAME_ONLY1990to2000
